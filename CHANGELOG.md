...
- Explicitly add fsspec and s3fs to conda-packages.txt
...
- Added rpy2 and r-reticulate to conda-packages.txt
- Added inject-env.py to inject environment variables into the RStudio environment
